...
$link = mysqli_connect('RDS_HOSTNAME', 'RDS_USERNAME', 'RDS_PASSWORD', 'ebdb', 3306);
$stmt = mysqli_prepare($link, "SELECT name, address1, address2, price, deliverydate, timeslot FROM `deliveries` WHERE `deliveryid`= ?");
...
mysqli_stmt_bind_result($stmt, $name, $address1, $address2, $unstyledprice, $deliverydate, $timeslot);
...
<h4 class="formsubtitle">Current Delivery Window</h4>

<?php
echo date('l, F jS', strtotime($deliverydate));
echo "<br>";
...
?>
  ...
  <form id="schedule-form">
    <h4 class="formsubtitle">New Delivery Window</h4>
